...
% within specimen (between replicates) procrustes distance
% between specimens and centroid procrustes distance for each classification scheme
% what graphs if any?
%   just put them in an online appendix?
