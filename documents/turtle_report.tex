...
% not necessary to show tables
% just use maps and mark which are misclassified
%   make train tiny dots and test large dots
%   misclassified are a different shape
